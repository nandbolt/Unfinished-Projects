/// @func	actor_ai_state_wander();
/// @desc	Actor AI's wandering state.
function actor_ai_state_wander()
{
...
/// @func	actor_ai_state_rush();
/// @desc	Actor AI's rushing state.
function actor_ai_state_rush()
{
	// Check if switching to state
	if (state_new)
	{
...
/// @func	actor_ai_state_combat();
/// @desc	Actor AI's combat state.
function actor_ai_state_combat()
{
