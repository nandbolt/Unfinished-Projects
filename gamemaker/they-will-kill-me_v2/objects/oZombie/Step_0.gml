...
if (object_exists(oHuman) && distance_to_object(oHuman) > 8 && !path_exists(curr_path))
{
	// Clear Path
	...
	var _goal_x = floor(oHuman.x/oGrid.cell_width), _goal_y = floor(oHuman.y/oGrid.cell_height);
